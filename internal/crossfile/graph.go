...
var (
	// taskPattern matches Task(agent-name) patterns.
...
func (v *CrossFileValidator) getNeighbors(componentType, name string) []string {
	...
	case cue.TypeCommand:
		return v.getCommandNeighbors(name)
	case cue.TypeAgent:
		return v.getAgentNeighbors(name)
	case cue.TypeSkill:
...
func (v *CrossFileValidator) getCommandNeighbors(name string) []string {
...
func (v *CrossFileValidator) getAgentNeighbors(name string) []string {
...
func (v *CrossFileValidator) extractAgentRefsFromPatterns(contents string) []string {
	var refs []string
	for _, re := range agentRefPatterns {
