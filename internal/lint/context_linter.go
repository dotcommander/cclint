...
func (l *ContextLinter) ValidateSpecific(data map[string]any, filePath, contents string) []cue.ValidationError {
	// Context-specific validation not yet implemented
	return nil
}

// parseMarkdownSections extracts section headers from markdown content.
// This is a stub implementation for the context linter.
func parseMarkdownSections(contents string) []string {
